            ...
            "paths": {
                ...
                "/requests": {
                    "get": {
                        ...
                        "description": "Требует наличия токена в cookie, подтверждённого email и роли `teamlead`. Возвращает массив всех существующих заявок на практику из города тимлида.",
                        "security": [
                            {
                                "CookieAuth": []
                            }
