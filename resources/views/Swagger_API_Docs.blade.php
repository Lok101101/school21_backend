            ...
            "paths": {
                ...
                "/requests/{id}/status": {
                    "patch": {
                        ...
                        "description": "Требует наличия токена в cookie. Ищет заявку по параметру `id` из URL. Если заявка не найдена — возвращает 404. Если найдена — обновляет её статус в соответствии с переданным кодом нового статуса. Список доступных статусов: `pending`, `accepted`, `rejected`, `canceled`",
                        "security": [
                            {
                                "CookieAuth": []
                            }
